...
class StoreServiceContributionRequest extends FormRequest
{
    /**
    ...
    public function rules(Request $request): array
    {
            ...
            $allowedWorkingDays = ["saturday","sunday","monday","tuesday","wednesday","thursday","friday"]; 
            $after_merge=[];
        $public_rules=[
            ...
            'service_type'=>["required", "string" , Rule::in(["food","education","health"])],

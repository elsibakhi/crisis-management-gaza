    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('add services')}}</h5>
...
<form action="{{route('service.store')}}" class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form" >
    <!--begin: Wizard Step 1-->
    @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-9 col-form-label">
                <div class="checkbox-inline">
                        @foreach (Auth::user()->workingDays as $workingDay)
                        <label class="checkbox checkbox-outline checkbox-dark">
                            <input type="checkbox" name="workingDays[]" value="{{$workingDay->day}}"/>
                            <span></span>
                            {{__($workingDay->day)}}
                        </label>
                        @endforeach
            ...
            @switch(Auth::user()->institutionData?->type)
                ...
                <div id="inputFields1">
                    <div class="input-container1 form-group fv-plugins-icon-container">
                        ...
                        <input name="specializations[][name]" class="  form-control form-control-solid form-control-lg m-2" type="text" placeholder="Enter a specialization" onkeydown="handleKeyDown(event,'inputFields1',1,'specialization')" onfocus="handleFocus(event,'inputFields1',1)">
                ...
                <div id="inputFields2">
                    <div class="input-container2 form-group fv-plugins-icon-container">
                        ...
                        <input name="targets[][name]" class="  form-control form-control-solid form-control-lg m-2" type="text" placeholder="Enter a target" onkeydown="handleKeyDown(event,'inputFields2',2,'target')" onfocus="handleFocus(event,'inputFields2',2)">
                        <div class="fv-plugins-message-container"></div>
                    </div>
                </div>
                ...
                <div id="inputFields3">
                    <div class="input-container3 form-group fv-plugins-icon-container">
                        ...
                        <input name="fields[][name]" class="  form-control form-control-solid form-control-lg m-2" type="text" placeholder="Enter a field" onkeydown="handleKeyDown(event,'inputFields3',3,'field')" onfocus="handleFocus(event,'inputFields3',3)">
                        <div class="fv-plugins-message-container"></div>
                    </div>
                </div>

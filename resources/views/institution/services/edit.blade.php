...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-muted">
        <a class="text-muted mr-2">{{__('edit')}} {{ $service->title }}</a>
    </li>
@endsection
@section('content')
    ...
    <div class="card card-custom w-75">
        <div class="card-body p-0">
            <!--begin: Wizard-->
            <div class="wizard wizard-2 w-100" id="kt_wizard" data-wizard-state="first" data-wizard-clickable="false">
                <!--begin: Wizard Nav-->
                    ...
                    <div class="wizard-steps">
                        <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                            <div class="wizard-wrapper">
                                <div class="wizard-icon">
                                    <span
                                        class="svg-icon svg-icon-2x"><!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/General/User.svg--><svg
                        ...
                        <div class="wizard-step" data-wizard-type="step" data-wizard-state="pending">
                            <div class="wizard-wrapper">
                                <div class="wizard-icon">
                                    <span
                                        class="svg-icon svg-icon-2x"><!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Map/Compass.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <div class="wizard-step" data-wizard-type="step" data-wizard-state="pending">
                            <div class="wizard-wrapper">
                                <div class="wizard-icon">
                                    <span
                                        class="svg-icon svg-icon-2x"><!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/General/Thunder-move.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    ...
    <!--end::Wizard Step 3 Nav-->
                        ...
                        <div class="wizard-step" data-wizard-type="step" data-wizard-state="pending">
                            <div class="wizard-wrapper">
                                <div class="wizard-icon">
                                    <span
                                        class="svg-icon svg-icon-2x"><!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/General/Like.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <form action="{{ route('service.update', $service->id) }}"
                                ...
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    ...
                                    <div class="form-group fv-plugins-icon-container">
                                        ...
                                        <input type="text"
                                            class="form-control form-control-solid form-control-lg w-100"
                                    ...
                                    <div class="form-group fv-plugins-icon-container">
                                        ...
                                        <textarea class="form-control form-control-solid form-control-lg" name="description" id="" cols="30" rows="10">{{$service->description}}</textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <select name="region" class="form-control form-control-lg form-control-solid " id="exampleSelectl" data-gtm-form-interact-field-id="1">
                                                    ...
                                                    <option @selected($service->location->region=="أم النصر") value="أم النصر">أم النصر</option>
                                                    <option @selected($service->location->region=="بيت لاهيا") vlaue="بيت لاهيا" >بيت لاهيا</option>
                                                    <option @selected($service->location->region=="بيت حانون") vlaue="بيت حانون" >بيت حانون</option>
                                                    <option @selected($service->location->region=="مخيم جباليا") vlaue="مخيم جباليا" >مخيم جباليا</option>
                                                    <option @selected($service->location->region=="جباليا") vlaue="جباليا" >جباليا</option>
                                                    <option @selected($service->location->region=="غزة") vlaue="غزة" >غزة</option>
                                                    <option @selected($service->location->region=="مخيم الشاطئ") vlaue="مخيم الشاطئ" >مخيم الشاطئ</option>
                                                    <option @selected($service->location->region=="الزهراء") vlaue="الزهراء" >الزهراء</option>
                                                    <option @selected($service->location->region=="المغراقة") vlaue="المغراقة" >المغراقة</option>
                                                    <option @selected($service->location->region=="جحر الديك") vlaue="جحر الديك" >جحر الديك</option>
                                                    <option @selected($service->location->region=="دير البلح") vlaue="دير البلح" >دير البلح</option>
                                                    <option @selected($service->location->region=="مخيم دير البلح") vlaue="مخيم دير البلح" >مخيم دير البلح</option>
                                                    <option @selected($service->location->region=="مخيم النصيرات") vlaue="مخيم النصيرات" >مخيم النصيرات</option>
                                                    <option @selected($service->location->region=="النصيرات") vlaue="النصيرات" >النصيرات</option>
                                                    <option @selected($service->location->region=="مخيم البريج") vlaue="مخيم البريج" >مخيم البريج</option>
                                                    <option @selected($service->location->region=="البريج") vlaue="البريج" >البريج</option>
                                                    <option @selected($service->location->region=="مخيم المغازي") vlaue="مخيم المغازي" >مخيم المغازي</option>
                                                    <option @selected($service->location->region=="المغازي") vlaue="المغازي" >المغازي</option>
                                                    <option @selected($service->location->region=="الزوايدة") vlaue="الزوايدة" >الزوايدة</option>
                                                    <option @selected($service->location->region=="المصدر") vlaue="المصدر" >المصدر</option>
                                                    <option @selected($service->location->region=="وادي السلقا") vlaue="وادي السلقا" >وادي السلقا</option>
                                                    <option @selected($service->location->region=="خان يونس") vlaue="خان يونس" >خان يونس</option>
                                                    <option @selected($service->location->region=="مخيم خان يونس") vlaue="مخيم خان يونس" >مخيم خان يونس</option>
                                                    <option @selected($service->location->region=="بني سهيلا") vlaue="بني سهيلا" >بني سهيلا</option>
                                                    <option @selected($service->location->region=="القرارة") vlaue="القرارة" >القرارة</option>
                                                    <option @selected($service->location->region=="حمد") vlaue="حمد" >حمد</option>
                                                    <option @selected($service->location->region=="عبسان الجديدة") vlaue="عبسان الجديدة" >عبسان الجديدة</option>
                                                    <option @selected($service->location->region=="عبسان الكبيرة") vlaue="عبسان الكبيرة" >عبسان الكبيرة</option>
                                                    <option @selected($service->location->region=="خزاعة") vlaue="خزاعة" >خزاعة</option>
                                                    <option @selected($service->location->region=="الفخاري") vlaue="الفخاري" >الفخاري</option>
                                                    <option @selected($service->location->region=="رفح") vlaue="رفح" >رفح</option>
                                                    <option @selected($service->location->region=="مخيم رفح") vlaue="مخيم رفح" >مخيم رفح</option>
                                                    <option @selected($service->location->region=="النصر(البيوك)") vlaue="النصر(البيوك)" >النصر(البيوك)</option>
                                                    <option @selected($service->location->region=="شوكة الصوفي") vlaue="شوكة الصوفي" >شوكة الصوفي</option>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <input type="text" class="form-control form-control-solid form-control-lg" name="address" value="{{$service->location->address }}" >
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <input type="hidden"  name="lat" value="{{ $service->location->lat }}"  >
                                        ...
                                        <div class="col-xl-6">
                                            <!--begin::Input-->
                                            <div class="form-group fv-plugins-icon-container">
                                                <input type="hidden"  name="lng" value="{{ $service->location->lng }}" >
                                ...
                                <div class="pb-5" data-wizard-type="step-content">
                                    ...
                                    <div class="form-group fv-plugins-icon-container">
                                        ...
                                        <input type="date" class="form-control form-control-solid form-control-lg"
                                            value="{{ $service->start_date }}" name="start_date"
                                    ...
                                    <div class="form-group fv-plugins-icon-container">
                                        ...
                                        <input type="number" class="form-control form-control-solid form-control-lg"
                                            value="{{ $service->period }}" name="period" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 col-form-label">
                                            <div class="checkbox-inline">
                                                    @foreach ($service->institution->workingDays as $workingDay)
                                                    <label class="checkbox checkbox-outline checkbox-dark">
                                                        <input type="checkbox"  @checked($service->workingDays()->where("day",$workingDay->day)->first()) name="workingDays[]" value="{{$workingDay->day}}"/>
                                                        <span></span>
                                                        {{__($workingDay->day)}}
                                                    </label>
                                                    @endforeach
                                    ...
                                    <div class="form-group fv-plugins-icon-container">
                                        ...
                                        <input type="time" class="form-control form-control-solid form-control-lg"
                                            value="{{ $service->start_time }}" name="start_time"
                                          >
                                    ...
                                    <div class="form-group fv-plugins-icon-container">
                                        ...
                                        <input type="time" class="form-control form-control-solid form-control-lg"
                                            value="{{ $service->end_time }}" name="end_time">
                                ...
                                <div class="pb-5" data-wizard-type="step-content">
                                    ...
                                    @switch($service->type)
                                        @case('food')
                                            <h4 class="mb-10 font-weight-bold text-dark">{{__('select service type')}}</h4>
                                            <!--begin::Select-->
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <select class="form-control" name="type">
                                                        ...
                                                        <option @selected($service->foodService->type == 'food_parcel') value="food_parcel">{{__('food parcel')}}
                                                        </option>
                                                        <option @selected($service->foodService->type == 'cooking') value="cooking">{{__('cooking')}}</option>
                                                        <option @selected($service->foodService->type == 'flour') value="flour">{{__('flour')}}</option>
                                                        <option @selected($service->foodService->type == 'gas') value="gas">{{__('gas')}}</option>
                                        ...
                                        @case('education')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <select class="form-control" name="status" id="costSelection"
                                                        onchange="toggleCostField()">
                                                        <option value="">{{__('select')}}</option>
                                                        <option @selected($service->educationService->status == 'charged') value="charged">{{__('charged')}}</option>
                                                        <option @selected($service->educationService->status == 'free') value="free">{{__('free')}}</option>
                                            ...
                                            <div id="costField"
                                                style="
                                             @if ($service->educationService->status == 'free') display: none; @endif
                                            
                                            "
                                                class="form-group fv-plugins-icon-container">
                                                <label>{{__('cost')}}</label>
                                                <input type="number"
                                                @if($service->educationService->status == 'charged') 
                                                    value="{{ $service->educationService->cost }}"
                                                 @endif
                                                    class="form-control form-control-solid form-control-lg" name="cost"
                                                    placeholder="200">
                                            ...
                                            <div class="alert alert-custom alert-notice alert-light-info fade show"
                                                role="alert">
                                            ...
                                            <div id="inputFields1">
                                                @foreach ($service->specializations as $specialization)
                                                    <div class="input-container1 form-group fv-plugins-icon-container">
                                                        ...
                                                        @endif
                                                        <input name="specializations[][name]" value="{{ $specialization->name }}"
                                                            class="  form-control form-control-solid form-control-lg m-2"
                                                            type="text" placeholder="Enter a specialization"
                                            ...
                                            <div id="inputFields2">
                                                @foreach ($service->targets as $target)
                                                    <div class="input-container2 form-group fv-plugins-icon-container">
                                                        ...
                                                        @endif
                                                        <input value="{{ $target->name }}" name="targets[][name]"
                                                            class="  form-control form-control-solid form-control-lg m-2"
                                                            type="text" placeholder="Enter a target"
                                                            onkeydown="handleKeyDown(event,'inputFields2',2,'target')"
                                                            onfocus="handleFocus(event,'inputFields2',2)">
                                                        @if ($loop->first)
                                                            <div class="fv-plugins-message-container"></div>
                                                        @endif
                                                    </div>
                                        ...
                                        @case('health')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <select class="form-control" name="type">
                                                        <option value="">{{__('select')}}</option>
                                                        <option @selected($service->healthService->type == 'hospital') value="hospital">{{__('hospital')}}</option>
                                                        <option @selected($service->healthService->type == 'medical_point') value="medical_point">{{__('medical point')}}
                                                        </option>
                                                        <option @selected($service->healthService->type == 'clinic') value="clinic">{{__('clinic')}}</option>
                                                        <option @selected($service->healthService->type == 'pharmacy') value="pharmacy">{{__('pharmacy')}}</option>
                                            ...
                                            <div class="alert alert-custom alert-notice alert-light-info fade show"
                                                role="alert">
                                                <div class="alert-icon"><i class="flaticon-light"></i></div>
                                                <div class="alert-text"> {{__('if you need to add another field , press')}} <span
                                                        class="label label-dark label-inline ">Enter</span> {{__('after fill the input')}}
                                                </div>
                                            ...
                                            <div id="inputFields3">
                                                ...
                                                @foreach ($service->fields as $field)
                                                    <div class="input-container3 form-group fv-plugins-icon-container">
                                                        ...
                                                        @endif
                                                        <input value="{{ $field->name }}" name="fields[][name]"
                                                            class="  form-control form-control-solid form-control-lg m-2"
                                                            type="text" placeholder="Enter a field"
                                                            onkeydown="handleKeyDown(event,'inputFields3',3,'field')"
                                                            onfocus="handleFocus(event,'inputFields3',3)">
                                                        @if ($loop->first)
                                                            <div class="fv-plugins-message-container"></div>
                                                        @endif
                                                    </div>
...
@push('scripts')
    <script>
        institution_type = '{{ $service->type }}';
        last_start_date = '{{ $service->start_date }}';
        var type = "Edit";
        const routes = {
            services_url: "{{ route('service.index') }}"
        }
    </script>
...
<!--end::Page Scripts-->
    <script src="{{ asset('assets/js/crisis_management/services/wizard-2.js') }}"></script>
    <script>
        var type = "Edit";
    </script>
    ...
    <script>
        ...
        function addInputField(inputFieldsID, inputContainerID, name) {
            ...
            newInputField.placeholder = 'Enter another ' + name;
...
// دالة لجلب وإضافة الملفات إلى Uppy
const addFilesToUppy = (files) => {
  files.forEach((file,index) => {
    fetch("/storage/"+file.path) // جلب الملف من المسار المحدد
      .then(response => response.blob()) // تحويله إلى Blob
      .then(blob => {
        // إضافة كل ملف إلى Uppy
        window.uppyDashboard.addFile({
          name: (index+1)+"."+file.extension,  // اسم الملف
          type: file.type,  // نوع الملف
          data: blob,       // البيانات (Blob)
          meta: {
            relativePath: file.path,  // المسار النسبي للملف
          },
          source: 'Local',  // مصدر الملف (محلي)
          isRemote: false,  // الملف ليس بعيدًا
        });
      })
      .catch(error => {
...
<script>
    window.page="Edit";
    window.address = "{{$service->location->address}}";
    window.lastLat = "{{ $service->location->lat}}";
    window.lastLng = "{{$service->location->lng}}";
</script>

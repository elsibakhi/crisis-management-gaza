...
<div class="col-12">
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                ...
                <div class=" w-100 mx-5 px-5 row justify-content-end">
                    ...
                    <button type="button" class="btn btn-primary m-3" data-toggle="modal" data-target="#Services">
                        {{__('add a service')}}
                    </button>
            </div>
            ...
            <div id="servicesModal">
                    @include('institution.services.modal')
 ...
 @endcan  
        ...
        <div class="card-body">
            ...
            <!--end Modal -->
            <!--begin: Datatable-->
            @include('institution.services.table')
            <!--end: Datatable-->
        </div>
    </div>
    {{-- end::Card --}}
...
<script>
    institution_type='{{Auth::user()->institutionData?->type}}';
</script>
...
<script>
    const routes = {
            list: "{{ route('service.list') }}",
            institution_store_url:"{{route('service.store')}}"

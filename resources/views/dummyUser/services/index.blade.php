        ...
        <div class="card card-custom mb-10 col-12" id="kt_card_3">
            ...
            <div class="card-header  ">
                <div class="card-title w-100 row justify-content-between  ">
                    <h2 class=""> {{__(str_replace("_"," ",$service_sub_type))}} </h2>
...
@push('scripts')
    ...
    <script>
        const load_services_route = "{{ route('dummyUser.service.load', ['service_type' => $service_type, 'service_sub_type' => $service_sub_type]) }}";

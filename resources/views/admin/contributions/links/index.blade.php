...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-muted">
        <a href="{{ route('admin.contribution.link.index') }}" class="text-muted mr-2">{{ __('link contribution') }}</a>
    </li>
@endsection
@section('content')
    <div class="col-12">
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">{{ __('all links') }}</h3>
                </div>
            ...
            <div class="card-body">
                ...
                <!--end Modal -->
                <!--begin: Datatable-->
                @include('admin.contributions.links.table')
                <!--end: Datatable-->
            </div>
        </div>
        {{-- end::Card --}}
...
@push('scripts')
    ...
    <script>
        const routes = {
            list: "{{ route('admin.contribution.link.list') }}",
...
function copyText(text) {
    ...
    toastr.info('copied', "The link has been copied.", { timeOut: 2000 });
}
 </script>

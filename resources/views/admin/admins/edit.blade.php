...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-muted">
        <a class="text-muted mr-2">{{__('edit')}} {{ $admin->name }}</a>
    </li>
@endsection
@section('content')
    <div class=" col-12 ">
                ...
                <div class="wizard wizard-1" id="kt_wizard" data-wizard-state="first" data-wizard-clickable="false">
                    ...
                    <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                        <div class="col-xl-12 col-xxl-7">
                            <!--begin::Wizard Form-->
                            <form action="{{route('admin.update',$admin->id)}}" class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form">
                                @csrf
                                @method("PUT")

                                <input type="hidden" name="institution_id" value="{{$admin->id}}">
                                <!--begin::Wizard Step 1-->
                                <div class="pb-5" data-wizard-type="step-content"  data-wizard-state="current">
                                    ...
                                    <div class="form-group fv-plugins-icon-container">
                                        <label>{{__('name')}}</label>
                                        <input value="{{$admin->name}}" type="text" class="form-control form-control-solid form-control-lg" name="name"
                                    ...
                                    <div class="form-group fv-plugins-icon-container">
                                        ...
                                        <input value="{{$admin->email}}" type="email" class="form-control form-control-solid form-control-lg" name="email"
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="form-group fv-plugins-icon-container">
                   ...
                   <option @selected($admin->hasRole($role->name)) value="{{$role->name}}">{{__($role->name)}}</option>
                ...
                <div class="col-12">
                    <div class="form-group fv-plugins-icon-container">
                       ...
                       <option @selected($admin->permissions()->where(["name"=>$permission->name])->first())  value="{{$permission->name}}">{{__($permission->name)}}</option>

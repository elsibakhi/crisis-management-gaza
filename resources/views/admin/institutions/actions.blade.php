@php
        ...
        $destroyRoute=route("institution.destroy",$row->id);
  ...
  <path d="M5,8.6862915 L5,5 L8.6862915,5 L11.5857864,2.10050506 L14.4852814,5 L19,5 L19,9.51471863 L21.4852814,12 L19,14.4852814 L19,19 L14.4852814,19 L11.5857864,21.8994949 L8.6862915,19 L5,19 L5,15.3137085 L1.6862915,12 L5,8.6862915 Z M12,15 C13.6568542,15 15,13.6568542 15,12 C15,10.3431458 13.6568542,9 12,9 C10.3431458,9 9,10.3431458 9,12 C9,13.6568542 10.3431458,15 12,15 Z" fill="#000000"></path>	            
        ...
        @can(["view institutions"])
                                    <li class="navi-item">	      
                                        ...
                                        <a href="{{route('institution.show',$row->id)}}" class="navi-link">	        
...
fas fa-lightbulb"></i></span>	         
                                    ...
                                    <li class="navi-item">	      
                                        ...
                                        <a href="{{route("institution.edit",$row->id)}}" class="navi-link">	        
                                            <span class="navi-icon"><i class="far fa-edit"></i></span>	         
                                                       <span class="navi-text">{{__('edit')}}</span>	      
                                                                ...
                                                                @can(["communication with institutions"])
                                                                @if ($row->institutionData->status=="accepted")
                                                                ...
                                                                <li class="navi-item">	      
                                                                    ...
                                                                    event.preventDefault();
                                                                     ...
                                                                     _load("chat-modal-div","{{route("load.chat.modal",$row->id)}}","kt_chat_modal");  ' href="#" class="navi-link">	        
                                                                        <span class="navi-icon"><i class="
far fa-comment-dots"></i></span>	         
                                                                                   <span class="navi-text">{{__('chat')}}</span>	      
                                                                                             </a>	 

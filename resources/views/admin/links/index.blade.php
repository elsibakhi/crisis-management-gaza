...
@can("create links")
                    ...
                    <div class=" w-100 mx-5 px-5 row justify-content-end">
                        ...
                        <button type="button" class="btn btn-primary m-3" data-toggle="modal" data-target="#Links">
                            {{ __('add a link') }}
                        </button>
                    </div>
...
@push('scripts')
    ...
    <script>
        const routes = {
            list: "{{ route('link.list') }}",
            institution_store_url: "{{ route('link.store') }}"
